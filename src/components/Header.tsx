    ...
    <header className="glass-card px-6 py-4 mb-8 rounded-2xl animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* Translator Join Button */}
          <button
            onClick={() => navigate("/rejoindre")}
            className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl glass-card hover:bg-primary/20 transition-all duration-300 text-xs font-medium text-foreground mr-2"
          >
